...
def main():
    ...
    schedule.every().day.at("12:45").do(find_direct_links_and_save)
    schedule.every().day.at("13:00").do(find_scores_and_write_to_ec2)
    schedule.every().day.at("13:15").do(find_direct_links_and_save)
    schedule.every().day.at("13:45").do(find_direct_links_and_save)
    schedule.every().day.at("14:15").do(find_direct_links_and_save)
    schedule.every().day.at("14:45").do(find_direct_links_and_save)
    schedule.every().day.at("15:15").do(find_direct_links_and_save)
    schedule.every().day.at("15:45").do(find_direct_links_and_save)
    schedule.every().day.at("16:15").do(find_direct_links_and_save)
    schedule.every().day.at("16:45").do(find_direct_links_and_save)
    schedule.every().day.at("17:15").do(find_direct_links_and_save)
    schedule.every().day.at("17:45").do(find_direct_links_and_save)
    schedule.every().day.at("18:15").do(find_direct_links_and_save)
    schedule.every().day.at("18:45").do(find_direct_links_and_save)
    schedule.every().day.at("19:15").do(find_direct_links_and_save)
    schedule.every().day.at("19:45").do(find_direct_links_and_save)
    schedule.every().day.at("20:15").do(find_direct_links_and_save)
    schedule.every().day.at("20:45").do(find_direct_links_and_save)
    schedule.every().day.at("21:15").do(find_direct_links_and_save)
    schedule.every().day.at("21:45").do(find_direct_links_and_save)
    schedule.every().day.at("22:15").do(find_direct_links_and_save)
    schedule.every().day.at("22:45").do(find_direct_links_and_save)
    while True:
